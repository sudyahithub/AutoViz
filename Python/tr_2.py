...
#   BOQ name, qty_type, qty_value, length, width, remarks
#
...
def sort_rows_for_category_blocks(rows: list[dict]) -> None:
    """In-place sort so identical categories become contiguous, and INSERT rows
    appear before LAYER_SUMMARY within the same category."""
    def _key(r):
