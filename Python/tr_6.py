...
import requests
import ezdxf
from ezdxf import colors as ezcolors  # NEW
...
def _make_color_swatch_b64(rgb: tuple[int,int,int], size_px:int=192) -> str:
    """Solid color swatch PNG for ByLayer sheet."""
    try:
        r,g,b = rgb
        fig = plt.figure(figsize=(size_px/100, size_px/100), dpi=100)
    ...
    with out_path.open("w", newline="", encoding="utf-8") as f:
        ...
        for r in rows:
            writer.writerow({
                ...
                "area":       r.get("area",""),
                "Preview":    "",  # Web App fills IMAGE() from uploaded file
