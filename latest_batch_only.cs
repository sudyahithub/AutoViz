...
// Commands:
//   CURVES2LWP, C2P  -> standard curve->LWP (smart-join, dup + near-twin filters)
//   C2PD             -> DENSIFY-ONLY (no smoothing): add vertices so segment <= Max
// Prompts: only "Max segment length". Always deletes originals. C# 7.3-safe.
